...
require (
	...
	github.com/openshift/origin v0.0.0-00010101000000-000000000000
...
replace (
	github.com/openshift/origin => github.com/openshift/origin v0.0.0-20250107154534-f3d6e3f3b0a4
